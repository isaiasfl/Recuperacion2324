...
import generarMatricula from '../helpers/generarMatricula'
import genrarBastidor from '../helpers/genrarBastidor'
...
const FormAltas = () => {
    ...
    let fechaActual="";
        ...
        function obtenerFechaActual() {
         ...
         const tieneRepetidosBastidores=(array,nbastidor)=>{
            const numbastidores=array && array.map(item =>item.nbastidor)
            console.log(numbastidores)
            return numbastidores.includes(nbastidor)
         }
