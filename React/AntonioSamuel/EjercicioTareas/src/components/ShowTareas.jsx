        ...
        <thead className="bg-gray-200">
          <tr>
            ...
            <th
              scope="col"
              className="px-6 py-3 text-center font-semibold text-gray-900 hover:bg-gray-400"
              onClick={handleOrderByPrioridad}
            >
              Prioridad
            </th>
          </tr>
          ...
          {tareas &&
            tareas.map((tarea, index) => (
              <tr key={index}>
                ...
                <td
                  className={`px-6 py-4 whitespace-nowrap ${getPriorityColor(
                    tarea.priority
                  )}`}
                >
                  <div className="text-sm text-center font-normal text-gray-900">
                    {getPriorityStars(tarea.priority)}
                  </div>
                </td>
              </tr>
            ))}
