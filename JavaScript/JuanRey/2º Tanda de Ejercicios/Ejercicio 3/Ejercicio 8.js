const Biblioteca = () =>{
    ...
    const añadirLibro = (id, titulo, autor) => {
...
biblioteca.añadirLibro(1, '1984', 'George Orwell');
biblioteca.añadirLibro(2, 'Brave New World', 'Aldous Huxley');
biblioteca.añadirLibro(3, 'Fahrenheit 451', 'Ray Bradbury');
